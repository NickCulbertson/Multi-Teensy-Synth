...
#define DX7_IMPLEMENTATION  // Define this before including to get the actual data definitions
#include "dx7_rom1a_unpacked.h"  // DX7 banks (now includes 2 banks)
...
int currentDX7Bank = 0;    // Currently selected bank (0-1)
...
// Bank names are now automatically generated by sysex2c.py in the header file
...
// DX7 banks are now loaded from dx7_rom1a_unpacked.h